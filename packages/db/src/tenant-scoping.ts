...
const DEFAULT_TENANT_SCOPED_MODELS = ['TenantConfig', 'Party', 'RoleAssignment', 'Engagement', 'Organization', 'Client', 'ClientCoachAssignment', 'ConsentRecord', 'MediaAsset', 'WorkflowDefinition', 'WorkflowStage', 'Evaluation', 'EvaluationPhoto', 'SatisfactionRecord', 'NutritionLog', 'Subscription', 'ExerciseCatalog', 'WorkoutPlan', 'PlanDay', 'TrainingSession', 'WorkoutDraft', 'EvaluationSchedule', 'EvaluationDueEvent', 'AuditLog', 'Invite', 'LedgerAccount', 'LedgerEntry', 'LedgerLine', 'PayoutHandle', 'PaymentRecord', 'ClientEngagementClock', 'CommissionAccrual', 'Settlement', 'Payslip'] as const;
